...
const PROGRAMS_DATA = [
  ...
  },
  {
    ...
    category: 'Degree Program',
    sub: 'Postgraduate · 2 Years · Full-Time · GATE / Interview',
    overview: 'Specialization in Space Systems Engineering, Operations, and Techniques for India\'s emerging space, geospatial, and defense sectors.',
    keywords: 'mtech m.tech space engineering postgraduate gate satellite systems',
    icon: '🛰️',
    view: 'programs',
    detailId: 'mtech',
  },
  {
    id: 'ms',
    title: 'MS (Research) in Space Sciences and Engineering',
    category: 'Degree Program',
    sub: 'Research Degree · 2 Years · Full-Time · GATE / Interview',
    overview: 'Specialized domain knowledge and substantial research exposure in Space Sciences and Engineering.',
    keywords: 'ms m.s. research space sciences engineering masters thesis gate',
    icon: '🛰️',
    view: 'programs',
    detailId: 'ms',
  },
  ...
  const fullIndex = useMemo(() => {
    ...
    facultyList.forEach((f, idx) => {
      ...
      items.push({
        ...
        title: f.name,
        category: 'Faculty',
        badge: isHOD ? 'Head of Dept.' : (isVisiting ? 'Visiting' : 'Faculty'),
    ...
    (data.events || []).forEach((ev, idx) => {
      ...
      items.push({
        ...
        title: ev.title,
        category: 'Events',
        badge: isUpcoming ? 'Upcoming' : 'Past Event',
    ...
    (data.publications || []).forEach((pub, idx) => {
      ...
      items.push({
        ...
        badge: isArchived ? 'Archived' : 'Publication',
