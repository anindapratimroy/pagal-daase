        ...
        <div key={i} className="batch-section">
          ...
          {yearData.phd?.length > 0 && (
            <div style={{ marginBottom: '18px' }}>
              <div style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '8px', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Ph.D.</div>
          ...
          {yearData.mtech?.length > 0 && (
            <div style={{ marginBottom: '18px' }}>
              <div style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '8px', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>M.Tech.</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
          ...
          {yearData.ms?.length > 0 && (
            <div style={{ marginBottom: '18px' }}>
              <div style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '8px', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>M.S. (Research)</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
          ...
          {yearData.msc?.length > 0 && (
            <div style={{ marginBottom: '18px' }}>
              <div style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '8px', fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>M.Sc.</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
