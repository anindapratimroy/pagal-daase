...
export const RESEARCH_AREAS = [
  ...
  },
  {
    ...
    desc: 'Interstellar medium, dynamical modeling of galaxies, dark matter distribution in galaxies, and circumgalactic medium.',
    full_description: "Areas of Interest\n\nInterstellar Medium, Dynamical modeling of galaxies, Dark matter distribution in galaxies, Circumgalactic medium.",
    image: 'images/research/Galaxies_and_Active_Galactic_Nuclei.png',
    faculty: ['Dr. Narendra Nath Patra', 'Dr. Priyanka Singh', 'Dr. Soumavo Ghosh', 'Dr. Amit Shukla']
  },
  {
    id: 'sun-heliosphere',
    title: 'Sun & Heliosphere',
    desc: 'Solar physics, computational astrophysics, ionospheric physics, and lower-upper atmosphere coupling.',
    full_description: "Solar Physics\nStudy of Sun, the nearest star and its physical processes through simulation, observation and modelling is the primary focus. A major focus is on space plasma processes in the Sun-Earth environment, aiming to create indigenous space weather modeling frameworks. Physics-based simulation as well as machine learning/AI approaches are used to study the behaviour of the Sun and the solar phenomena.\n\nComputational Astrophysics\nThis combines computational methods and algorithms for simulating and analyzing astrophysical data to discover new phenomena. Research also covers dynamical evolution of jets from Active Galactic Nuclei (AGN) and particle acceleration, using advanced simulations to predict observational features.\n\nIonospheric Physics\nIonosphere is the ionized region of Earth's atmosphere and is crucial for all space-based communication, navigation as well as remote sensing satellites. The major thrust is on understanding the ionospheric characteristics, both in low latitude as well as high latitude. The coupling between Space Weather phenomena and the Ionosphere is one such challenging area, particularly as society is increasingly becoming a technology-driven society where any disruption in the satellite system is a billion-dollar problem. The researchers are actively exploring the impact.\n\nLower-Upper Atmosphere Coupling\nThe Earth has both a neutral atmosphere at lower heights in addition to ionized layers above. The interaction between these two regions shapes the characteristics of both regions. The potential difference between Earth's crust and the Ionosphere maintains a current which is modulated by thunderstorms and other phenomena. The Space Weather impacts the lower atmosphere through complex mechanisms connecting the Magnetosphere-Ionosphere-lower atmosphere. In addition, the energy transport to the upper atmosphere by waves of various nature generated in the lower atmosphere modulates the ionospheric characteristics. The current research is focused on the study of these interactions from both the top side and bottom side.",
  ...
  },
  {
    ...
    desc: 'Cloud and precipitation physics, polar meteorology, numerical weather prediction, radar meteorology, and SAR remote sensing.',
    full_description: "Cloud and Precipitation Physics\nCloud plays a crucial role in Earth's radiation budget and is a key component of the hydrological cycle. The formation, evolution, and dissipation of cloud are closely linked with aerosols and are a serious concern in climate change scenarios. There are several unanswered questions about how cloud and precipitation are linked and modulated. The thrust of this group is to improve the understanding of precipitation characteristics and its spatio-temporal evolution using satellite and ground-based observations, both in tropical regions like India as well as in polar regions like the Arctic. Understanding of precipitation processes not only improves the Quantitative Precipitation Estimation (QPE) from remote sensing observations, but also helps in the development of better forecasting models. Doppler weather radar is one such remote sensing tool which is extensively being used for precipitation remote sensing that is directly benefitted from our research.\n\nPolar Meteorology\nThe unique atmospheric conditions of the Earth's polar regions are characterized by extreme cold, low moisture, high surface reflectivity (albedo), and strong seasonal temperature variations, including the presence of the polar vortex and ozone-depleting polar stratospheric clouds. Key phenomena include katabatic winds, influenced by dense, cold air, and the complex interaction of space weather with the polar ionosphere. Research in polar meteorology is crucial for understanding global climate change, as the poles act as significant heat sinks and areas of accelerated warming, known as polar amplification, which can also influence weather patterns at lower latitudes. DAASE has established an experimental facility since 2022 at Himadri, Ny-Ålesund, in the northernmost human settlement to study the precipitation, cloud, atmospheric electricity, lightning, and space weather phenomena.\n\nNumerical Weather Prediction and Climate-informatics\nExtreme weather events are a major concern to society and more so as climate change increases the number of such events and associated fatalities all over the world. Numerical Weather Prediction (NWP) uses physics-based models to diagnose and forecast weather phenomena. We actively use WRF models for studying extreme weather conditions as well as for developing improved parameterization schemes. There is also active research going on to develop AI/ML techniques for better predictions of extreme weather events such as cyclones, thunderstorms, turbulence, and lightning, combining satellite and NWP models.\n\nRadar Meteorology\nRadar meteorology is a branch of atmospheric science that uses radar technology to study and forecast weather phenomena. By transmitting electromagnetic waves and analyzing the signals reflected by atmospheric targets — such as raindrops, snow, and hail — meteorologists can determine the location, movement, and intensity of precipitation. Investigating the size, shape, and phase (e.g., rain, snow, hail) of hydrometeors in different weather systems, including tropical cyclones and convective storms, provides microphysical insights of the physical processes. Developing more accurate rainfall estimation algorithms that mitigate errors from varying raindrop size distributions and signal attenuation, especially in heavy rain, and thus improving Quantitative Precipitation Estimation (QPE) is one of the major thrusts of the group.\n\nSynthetic Aperture Radar\nPolarimetric SAR, PolInSAR, Tomography\n\nRemote Sensing in Earth Observation\nHyperspectral, microwave, and optical remote sensing — all have their own advantages and disadvantages in Earth observation studies. Some of the major areas where DAASE faculty are involved include change detection, classification, and forestry applications.",
    image: 'images/research/Space_Weather_and_Atmospheric_Science.png',
    faculty: ['Dr. Saurabh Das', 'Dr. Unmesh Khati', 'Dr. Bhargav Vaidya']
  },
  {
    id: 'instrumentation',
    title: 'Communication, Navigation & Remote Sensing',
    desc: 'Satellite-based navigation (GNSS/GPS/NavIC), drone navigation, satellite communication, CubeSat systems, space-based systems, and detector simulation.',
    full_description: "Areas of Interest\n\nSatellite Based Navigation\n• GNSS/GPS/NavIC\n• Drone navigation\n\nSatellite Communication\n• V/Ka/Ku band channel modelling\n• CubeSat communication\n• IoT\n• Rural technology\n\nSpace Based Systems\n• Small Satellite Payload, Navigation, Control\n\nDetector Simulation and Calibration\n• Gamma Ray Detectors",
