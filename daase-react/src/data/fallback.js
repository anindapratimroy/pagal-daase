...
export const RESEARCH_AREAS = [
  {
    ...
    image: 'images/research/Compact Objects & Transients.png',
  ...
  },
  {
    ...
    image: 'images/research/Galaxies and Active Galactic Nuclei.png',
  ...
  },
  {
    ...
    image: 'images/research/Sun and Heliosphere.png',
  ...
  },
  {
    ...
    image: 'images/research/Space Weather and Atmospheric Science.png',
  ...
  },
  {
    ...
    image: 'images/research/Communication, Navigation and Remote Sensing.png',
  ...
  },
  {
    ...
    image: 'images/research/Data Science & ML in Astrophysics.png',
...
export const FACILITIES_FB = [
  { name: "3D Printer", image: "/images/facilities/3D Printer.JPG" },
  { name: "4 channel DSO with function generator", image: "/images/facilities/4 channel DSO with function generator.JPG" },
  { name: "AMS with SDR", image: "/images/facilities/AMS with SDR.JPG" },
  { name: "AWS 2", image: "/images/facilities/AWS 2.JPG" },
  { name: "AWS", image: "/images/facilities/AWS.JPG" },
  { name: "Actual Cube set", image: "/images/facilities/Actual Cube set.jpeg" },
  { name: "Anechoic Chamber 3", image: "/images/facilities/Anechoic Chamber 3.jpeg" },
  { name: "Anechoic chamber 1", image: "/images/facilities/Anechoic chamber 1.jpeg" },
  { name: "Anechoic chamber 2", image: "/images/facilities/Anechoic chamber 2.jpeg" },
  { name: "Annemometer", image: "/images/facilities/Annemometer.JPG" },
  { name: "Antenna Measurment System", image: "/images/facilities/Antenna Measurment System.JPG" },
  { name: "Ceilometer 2", image: "/images/facilities/Ceilometer 2.jpeg" },
  { name: "Ceolimeter 1", image: "/images/facilities/Ceolimeter 1.JPG" },
  { name: "Departmental Server 2", image: "/images/facilities/Departmental Server 2.JPG" },
  { name: "Departmental Server", image: "/images/facilities/Departmental Server.JPG" },
  { name: "Digital IC Trainer kit", image: "/images/facilities/Digital IC Trainer kit.JPG" },
  { name: "Drone for Hyperspectral Imagery", image: "/images/facilities/Drone for Hyperspectral Imagery.JPG" },
  { name: "Drone for SAR and Hyperspectral Imagery", image: "/images/facilities/Drone for SAR and Hyperspectral Imagery.JPG" },
  { name: "EDC lab", image: "/images/facilities/EDC lab.jpeg" },
  { name: "Electronic Workbench 1", image: "/images/facilities/Electronic Workbench 1.JPG" },
  { name: "FPGA Device Testing Area 2", image: "/images/facilities/FPGA Device Testing Area 2.JPG" },
  { name: "FPGA Device Testing Area", image: "/images/facilities/FPGA Device Testing Area.JPG" },
  { name: "FPGA system with electronic workbench", image: "/images/facilities/FPGA system with electronic workbench.JPG" },
  { name: "Faraday' s effect setup", image: "/images/facilities/Faraday' s effect setup.JPG" },
  { name: "Febry Perot Interferometer", image: "/images/facilities/Febry Perot Interferometer.JPG" },
  { name: "G. M. Counter", image: "/images/facilities/G. M. Counter.JPG" },
  { name: "GNSS Transmitter Receiver", image: "/images/facilities/GNSS Transmitter Receiver.jpeg" },
  { name: "GNSS measurment system 1", image: "/images/facilities/GNSS measurment system 1.JPG" },
  { name: "GNSS", image: "/images/facilities/GNSS.JPG" },
  { name: "Helmholtz cage", image: "/images/facilities/Helmholtz cage.jpeg" },
  { name: "Hyperspectral Camera 1", image: "/images/facilities/Hyperspectral Camera 1.JPG" },
  { name: "Hyperspectral Camera 2", image: "/images/facilities/Hyperspectral Camera 2.JPG" },
  { name: "In- house Drone 1", image: "/images/facilities/In- house Drone 1.JPG" },
  { name: "IoT setup", image: "/images/facilities/IoT setup.JPG" },
  { name: "LPM 1", image: "/images/facilities/LPM 1.JPG" },
  { name: "Lab Discussion 1", image: "/images/facilities/Lab Discussion 1.JPG" },
  { name: "MOKUGO Powered Advanced Electronic Workbench", image: "/images/facilities/MOKUGO Powered Advanced Electronic Workbench.JPG" },
  { name: "Malus law setup- Optics lab", image: "/images/facilities/Malus law setup- Optics lab.JPG" },
  { name: "Michaelson Interferometer 1", image: "/images/facilities/Michaelson Interferometer 1.JPG" },
  { name: "Michaelson Interferometer 2", image: "/images/facilities/Michaelson Interferometer 2.JPG" },
  { name: "Microwave demonstration setup", image: "/images/facilities/Microwave demonstration setup.JPG" },
  { name: "Mini Whip", image: "/images/facilities/Mini Whip.JPG" },
  { name: "Multi-function interferometer- Optics lab", image: "/images/facilities/Multi-function interferometer- Optics lab.JPG" },
  { name: "Particle size experiment- Optics lab", image: "/images/facilities/Particle size experiment- Optics lab.JPG" },
  { name: "Plasma Diagnostics using Spectroscopy", image: "/images/facilities/Plasma Diagnostics using Spectroscopy.JPG" },
  { name: "Polarization Mirrors", image: "/images/facilities/Polarization Mirrors.JPG" },
  { name: "Precipitation Radar for rain monitoring", image: "/images/facilities/Precipitation Radar for rain monitoring.JPG" },
  { name: "Precipitation Radar", image: "/images/facilities/Precipitation Radar.JPG" },
  { name: "Precision cut CNC machine", image: "/images/facilities/Precision cut CNC machine.JPG" },
  { name: "RCS Setup", image: "/images/facilities/RCS Setup.JPG" },
  { name: "RCS measurment setup", image: "/images/facilities/RCS measurment setup.JPG" },
  { name: "RF measurments instruments and Vector Network Analyzer", image: "/images/facilities/RF measurments instruments and Vector Network Analyzer.jpeg" },
  { name: "Radio Interferometer", image: "/images/facilities/Radio Interferometer.jpeg" },
  { name: "Red Pitiya FPGA Board", image: "/images/facilities/Red Pitiya FPGA Board.JPG" },
  { name: "Reynold's Apparatus", image: "/images/facilities/Reynold's Apparatus.JPG" },
  { name: "SIPM Experiment Device for Detector's Lab", image: "/images/facilities/SIPM Experiment Device for Detector's Lab.JPG" },
  { name: "STARC Lab instruments", image: "/images/facilities/STARC Lab instruments.JPG" },
  { name: "Satellite Communication Kit", image: "/images/facilities/Satellite Communication Kit.JPG" },
  { name: "Scintillator Detector", image: "/images/facilities/Scintillator Detector.JPG" },
  { name: "Server Control room", image: "/images/facilities/Server Control room.jpeg" },
  { name: "Soldering sations EDC lab", image: "/images/facilities/Soldering sations EDC lab.JPG" },
  { name: "Telescope 1", image: "/images/facilities/Telescope 1.JPG" },
  { name: "Telescope 2", image: "/images/facilities/Telescope 2.JPG" },
  { name: "Telescope Manuvere Control", image: "/images/facilities/Telescope Manuvere Control.JPG" },
  { name: "Temperature Estimator", image: "/images/facilities/Temperature Estimator.JPG" },
  { name: "Twin satellite communication system", image: "/images/facilities/Twin satellite communication system.JPG" },
  { name: "U Blox 2", image: "/images/facilities/U Blox 2.jpeg" },
  { name: "U Blox", image: "/images/facilities/U Blox.JPG" },
  { name: "UHF, VHF, GNSS, LPM and other weather sensors", image: "/images/facilities/UHF, VHF, GNSS, LPM and other weather sensors.jpeg" },
  { name: "UHF-VHF RF Antennas 1", image: "/images/facilities/UHF-VHF RF Antennas 1.JPG" },
  { name: "Universal Computer Spectrometer", image: "/images/facilities/Universal Computer Spectrometer.JPG" },
  { name: "Weather Sensor 1", image: "/images/facilities/Weather Sensor 1.JPG" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.27", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.27.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.31", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.31.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.33", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.33.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.35", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.35.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.39", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.39.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.40", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.40.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.41", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.41.jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.44 (1)", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.44 (1).jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.44 (2)", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.44 (2).jpeg" },
  { name: "WhatsApp Image 2026-06-17 at 23.19.44", image: "/images/facilities/WhatsApp Image 2026-06-17 at 23.19.44.jpeg" },
  { name: "Zeeman effect 2", image: "/images/facilities/Zeeman effect 2.JPG" },
  { name: "Zeeman effect experiment setup", image: "/images/facilities/Zeeman effect experiment setup.JPG" },
